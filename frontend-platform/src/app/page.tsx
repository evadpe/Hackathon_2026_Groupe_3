    ...
    <div className="p-8 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-10">
        <div>
          ...
          <p className="text-gray-500 mt-1">Bienvenue sur votre plateforme d&apos;analyse documentaire IA.</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-gradient-to-br from-blue-600 to-indigo-700 rounded-3xl p-8 text-white shadow-xl flex flex-col justify-between">
          <div>
            ...
            <h2 className="text-2xl font-bold mb-3">Prêt pour l&apos;importation ?</h2>
            <p className="text-blue-100 mb-8 max-w-sm">
              Tous vos documents validés en zone Gold peuvent être consultés dans l&apos;espace métier pour un interfaçage CRM immédiat.
            </p>
          </div>
          <Link 
            href="/crm" 
        ...
        <div className="bg-white border border-gray-100 rounded-3xl p-8 shadow-sm">
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              <h2 className="font-bold text-xl text-gray-900">IA & Conformité</h2>
          ...
          <div className="space-y-4">
            <div className="p-4 bg-gray-50 rounded-2xl border border-gray-100 flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <span className="font-medium text-gray-700">Extractions Factures</span>
              </div>
              <span className="text-sm font-bold text-blue-600">Précision 98%</span>
            </div>
            <div className="p-4 bg-gray-50 rounded-2xl border border-gray-100 flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 bg-white rounded-lg flex items-center justify-center shadow-sm">
                ...
                <span className="font-medium text-gray-700">Analyse de Conformité</span>
              </div>
              <span className="text-sm font-bold text-blue-600">Règles Actives</span>
            </div>
          </div>

          <div className="mt-8 pt-6 border-t border-gray-50">
             <Link href="/conformite" className="text-blue-600 font-bold text-sm hover:underline flex items-center gap-1 w-fit">
